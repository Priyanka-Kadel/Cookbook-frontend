    ...
    <div>
      ...
      <div className="container mx-auto px-4 md:px-6 py-10">
        ...
        <p className="text-lg text-gray-700 mb-6 font-bold">
          Welcome to basobasmitra. Your privacy is of paramount importance to us. This Privacy Policy outlines the types of personal information that is collected and recorded by basobasmitra and how we use it. By using this website, you consent to the terms of this Privacy Policy.
        </p>
        ...
        <section className="bg-indigo-50 border-l-4 border-indigo-500 shadow-md rounded-lg p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700">
            basobasmitra collects personal information when you use our services, such as when you register an account, make a booking, or communicate with us. The types of personal data we collect include:
            <ul className="list-disc pl-6 mt-2">
              ...
              <li>Communication with basobasmitra, including support requests and inquiries.</li>
            </ul>
          </p>
        </section>
        ...
        <section className="bg-indigo-50 border-l-4 border-indigo-500 shadow-md rounded-lg p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700">
            basobasmitra takes reasonable precautions to protect your personal data. However, no system is completely secure. While we strive to protect your data, we cannot guarantee absolute security of your information.
          </p>
        </section>
        ...
        <section className="bg-indigo-50 border-l-4 border-indigo-500 shadow-md rounded-lg p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700">
            basobasmitra does not sell or rent your personal data to third parties. We may share your information with trusted service providers who help us operate our platform or process transactions, but only for the purposes stated in this Privacy Policy.
          </p>
        </section>
        ...
        <section className="bg-indigo-50 border-l-4 border-indigo-500 shadow-md rounded-lg p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700">
            basobasmitra uses cookies to enhance your experience on our website. Cookies are small files that are stored on your device and help us remember your preferences and improve functionality.
          </p>
        </section>
        ...
        <section className="bg-indigo-50 border-l-4 border-indigo-500 shadow-md rounded-lg p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700">
            basobasmitra may update this Privacy Policy from time to time. Any changes will be posted on this page, and we encourage you to review it periodically for updates.
          </p>
        </section>
        ...
        <section className="bg-indigo-50 border-l-4 border-indigo-500 shadow-md rounded-lg p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700">
            ...
            <ul className="list-none pl-6 mt-2">
              ...
              <li>Phone: +977-9862242899</li>
              <li>Address: Lamatar, Lalitpur 44600</li>
            </ul>
          </p>
        </section>
      </div>
