...
import forgotBg from '../../assets/images/for.png'; // Import local image
            ...
            <div className="w-full max-w-md bg-white/90 backdrop-blur-lg p-8 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 px-4 text-white font-semibold rounded-md shadow-md hover:opacity-90 focus:outline-none"
                        style={{ backgroundColor: "#509343" }}
                    >
